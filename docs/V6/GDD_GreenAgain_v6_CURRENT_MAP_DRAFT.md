# Green Again v6 - Current Map Draft
...
Cống thoát nước cuối xóm
        |
        v
Ngõ dân cư sau mưa + góc sống nhỏ
        |
        v
Nhà văn hóa ending
```
...
```text
                 ...
                 Cô Hạnh, Em Phúc, ngõ sau mưa, góc cây nhỏ
                                      |
                                      |
                               TẠP HÓA CÔ TƯ
  ...
  bắt đầu      hub kể chuyện     tutorial phân loại        Anh Tùng, Bé Na
               Bác Xanh          / rác cộng đồng           rác sau vui chơi
                                                       ...
                                                       rác tụ, nghẹt, hậu quả
                                                                  |
                                                                  |
                                                QUAY LẠI NGÕ DÂN CƯ / TRỒNG CÂY
                                           thấy ảnh hưởng gần nhà, chăm chỗ sống nhỏ
```
...
| `ResidentialSt` / xóm ven đường nhỏ | `Thị trấn / làng Ven Sông`, một cụm dân cư lớn hơn và phải có tuyến truyện riêng ở Ch5 |
...
| Địa điểm v6 | Tên kỹ thuật hiện có | Vai trò không gian | Vai trò story |
|---|---|---|---|
...
| Thị trấn / làng Ven Sông | `ResidentialSt` + cụm building dân cư | Cụm làng bên trái/trên hub | Chứng minh rác đến từ sinh hoạt thường ngày, và ở Ch5 cho thấy hậu quả quay lại ngay đường đi học/ngõ nhà. |
| Ngõ dân cư sau mưa | Một đoạn trong `ResidentialSt` hoặc runtime anchor `ResidentialLane` | Đoạn đường nhỏ trong cụm làng | Tuyến Ch5: Cô Hạnh và Em Phúc chỉ ra rác sau mưa, mương/ngõ đọng rác, đường đi học bẩn. |
| Góc sống nhỏ | Gốc cây/bụi cỏ/bát nước gần `ResidentialSt`, có thể dùng runtime anchor `SmallLivesCorner` | Một điểm nhỏ cạnh ngõ dân cư | Beat Ch5 dễ implement: dọn rác nguy hiểm, đặt bát nước/biển nhỏ, cho prop/sound chim-mèo-cún xuất hiện lại. |
...
- Không gọi `PicnicArea` là `Công viên`, `Bãi picnic`, hoặc `Bãi cỏ ven sông` nữa. Trong story v6, đây là `Sân bóng thôn Ven Sông`.
- Không gọi `Dam_C1/C2/C3` là `Đập` nữa. Trong story v6, đây là `Cống thoát nước cuối xóm`.
...
### Chapter 5 - Cống cuối xóm và những chỗ sống nhỏ
...
-> khúc cong
-> cống thoát nước cuối xóm
-> điểm tập kết rác / phân loại rác cống
-> quay lại khu dân cư sau mưa
-> góc sống nhỏ cho động vật
-> trồng cây / các điểm phòng ngừa
-> Nhà văn hóa
```
...
- Chapter 5 không chỉ là dọn cống. Nó gồm 7 phase: thấy hậu quả, dọn cống, phân loại rác cống, gọi cộng đồng, quay lại khu dân cư, chăm góc sống nhỏ/trồng cây, quay về Nhà văn hóa.
- Điểm tập kết rác trở lại như nơi biến "dọn rác" thành "rác đi đúng chỗ".
- Khu dân cư phải được tận dụng như nơi hậu quả quay lại đời sống: đường đi học, mương/ngõ sau mưa, gốc cây, chỗ chim/mèo/cún hay lui tới.
- Tạp hóa, Sân bóng, bờ sông và ngõ dân cư nên có ít nhất 4-5 hành động phòng ngừa đại diện: thùng rác, biển nhắc, bát nước/khay nhỏ cho động vật, cây xanh hoặc cam kết NPC.
...
- Cô Hạnh: nhận phần giữ ngõ dân cư, chia việc nhỏ theo từng nhà.
- Em Phúc: cho thấy trẻ con đi qua rác mỗi ngày và chăm cây non sau ending.
...
| Loại zone | Cách dùng v6 đề xuất |
|---|---|
| Thùng rác | Nên có gần Tạp hóa Cô Tư, gần Sân bóng, và điểm phân loại lớn ở Điểm tập kết rác. |
| Biển báo | Nên đặt ở lối vào Nhà văn hóa, đường Tạp hóa -> Sân bóng, gần bờ sông Ông Sáu, gần Cống thoát nước, hoặc đầu ngõ dân cư. |
| Cây xanh | V6 nên trồng ít nhất 3 cây non có ý nghĩa: một cây ở ngõ dân cư/đường đi học, một cây gần Nhà văn hóa, một cây gần bờ sông hoặc sân bóng. |
| Góc động vật | Không cần rescue phức tạp. Dùng một runtime prop đơn giản: bát nước, khay nhỏ, bụi cây sạch, hoặc một prop/sound cue chim-mèo-cún xuất hiện sau khi rác nguy hiểm được dọn. |
...
Map hiện tại chỉ có vài NPC chính nên cảm giác câu chuyện còn mỏng. V6 nên thêm NPC phụ theo cụm, ưu tiên thoại ngắn và vai trò rõ, không biến tất cả thành quest giver.
...
| Thị trấn / làng | Chưa có rõ ngoài Cô Tư gần đó | Cô Hạnh tổ dân phố, Em Phúc học sinh | Trở thành tuyến Ch5: rác sau mưa ảnh hưởng ngõ nhà, đường đi học, góc cây và động vật nhỏ. |
...
## 12. North Star map v6

Map v6 phải giúp người chơi hiểu nguyên nhân và hậu quả theo không gian:
...
Rác trôi xuống sông và mắc ở cống
        |
        v
Hậu quả quay lại ngõ dân cư, cây xanh và chỗ sống nhỏ
        |
        v
...
- `Ngõ dân cư sau mưa`: Khi cống nghẹt, hậu quả quay lại đường đi học và nhà dân ra sao?
- `Góc sống nhỏ`: Nếu rác nằm ở gốc cây/bụi cỏ, những sinh vật nhỏ quanh làng bị ảnh hưởng thế nào?
...
- `Cây non`: Mỗi người có thể chăm phần nhỏ nào sau khi dọn xong hậu quả?
