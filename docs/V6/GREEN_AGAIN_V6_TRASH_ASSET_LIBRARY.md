# Green Again V6 - Trash Asset Library
...
```text
Workspace.GreenAgainV6_StoryRuntime
```
...
- `StoryRuntimeMVP` hiện đã clone cleanup trash và sorting bin visuals từ thư viện này vào `Workspace.GreenAgainV6_StoryRuntime`.
...
| `GreenAgainV6` | `true` |
| `AssetLibrary` | `true` |
| `LibraryVersion` | `V6_TrashLibrary_2026_07_03` |
...
| Attribute | Purpose |
|---|---|
| `GreenAgainV6=true` | Marks asset as part of V6 tooling |
...
2. Clone it into `Workspace.GreenAgainV6_StoryRuntime`.
...
- Runtime replacement verification on 2026-07-04:
  - Play mode spawned `16` cleanup trash clones from `Workspace.Trash` into `Workspace.GreenAgainV6_StoryRuntime`.
